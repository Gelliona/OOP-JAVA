    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("""
                    -----------------------------------------------------------------------------
                    Доступные действия:
                    1. Для создания робота введите create x y, где x и y - координаты размещения
                    ...
                    5. Для удаления робота введите delete id step, где id - идентификатор робота, step - количество шагов
        ...
        private void initMoveCommandHandler(){
            handlers.add(new CommandHandler(){
                ...
                public void runCommand(String[] args) {
                 ...
                 //   robot.ifPresentOrElse(RobotMap.Robot::move, () -> System.out.println("Робот" + robotId + " не найден"));
